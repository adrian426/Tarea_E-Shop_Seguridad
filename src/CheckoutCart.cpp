...
int main(int argc, char** argv, char** envp){
    ...
    if(rst == 1){
        ...
        cout << "<input type='button' value='Continue' onclick=\"location.href='172.24.129.95/cgi-bin/Tarea1_Seguridad/Home'\">";
        cout << ("</body>\n");
        cout << ("</html>\n");
    } else {
        cout << "Content-type:text/html\r\n\r\n";
        ...
        cout << "<input type='button' value='Cart' onclick=\"location.href='172.24.129.95/cgi-bin/Tarea1_Seguridad/review_cart'\">";
        cout << ("</body>\n");
        cout << ("</html>\n");
    }
  return EXIT_SUCCESS;
