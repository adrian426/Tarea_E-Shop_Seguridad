...
int main(int argc, char** argv, char** envp){
    ...
    cout << ("<div><input type='button' value='Cancel' onclick=\"location.href='http://172.24.129.81/cgi-bin/Tarea1_Seguridad/review_claims'\"> <input type='submit' value='Submit'></div>\n");
    cout << ("</form>\n");
    cout << ("</body>\n");
    cout << ("</html>\n");
    return EXIT_SUCCESS;
